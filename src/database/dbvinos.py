...
def inicializarBaseVinos():
    ...
    cursor.execute("INSERT INTO vinos (nombre, anada, fechaActualizacion, imagenEtiqueta, precioARS, notaDeCataBodega, bodegaNombre, maridajeNombre, varietalNombre) VALUES (?,?,?,?,?,?,?,?,?)",
                   ('Trivento', 2000, datetime(2024,12,16).date(), 'imagen.jpg', 7000, 8, 'Roble', 'Papas', 'Varietal 1'))
    cursor.execute("INSERT INTO vinos (nombre, anada, fechaActualizacion, imagenEtiqueta, precioARS, notaDeCataBodega, bodegaNombre, maridajeNombre, varietalNombre) VALUES (?,?,?,?,?,?,?,?,?)",
                   ('GarnachaRosé', 2002, datetime(2024,7,15).date(), 'imagen.jpg', 10000, 10,'Viñedos', 'Carne', 'Varietal 4'))
    cursor.execute("INSERT INTO vinos (nombre, anada, fechaActualizacion, imagenEtiqueta, precioARS, notaDeCataBodega, bodegaNombre, maridajeNombre, varietalNombre) VALUES (?,?,?,?,?,?,?,?,?)",
                   ('VinoLandi', 1999, datetime(2024,5,14).date(), 'imagen.jpg', 1500, 4,'Viñedos', 'Empanadas', 'Varietal 7'))
    cursor.execute("INSERT INTO vinos (nombre, anada, fechaActualizacion, imagenEtiqueta, precioARS, notaDeCataBodega, bodegaNombre, maridajeNombre, varietalNombre) VALUES (?,?,?,?,?,?,?,?,?)",
                   ('SyrahReservaEspecial', 2010, datetime(2024,1,13).date(), 'imagen.jpg', 4500, 7,'Olivo', 'Pescado', 'Varietal 3'))
    cursor.execute("INSERT INTO vinos (nombre, anada, fechaActualizacion, imagenEtiqueta, precioARS, notaDeCataBodega, bodegaNombre, maridajeNombre, varietalNombre) VALUES (?,?,?,?,?,?,?,?,?)",
                   ('VinoFigueroa', 2010, datetime(2024,6,12).date(), 'imagen.jpg', 3500, 1,'Roble', 'Pastas', 'Varietal 2'))
